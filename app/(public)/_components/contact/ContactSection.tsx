...
function buildContactCards(company: Company) {
  ...
  return [
    ...
    },
    {
      ...
      title: "Email Us",
      lines: [contact.email.general, contact.email.visa, contact.email.ielts],
        ...
        <ScrollReveal>
          <div className="text-center max-w-2xl mx-auto mb-14">
            <span className="section-label text-accent-600 mb-3">
              <span className="w-8 h-0.5 bg-accent-400 rounded" /> Get In Touch{" "}
            ...
            <p className="text-lg text-slate-500">
              Book a free counseling session. No pressure, just honest advice
              ...
              {status === "success" ? (
                <div className="flex flex-col items-center text-center py-10">
                  ...
                  <p className="text-sm text-slate-500 max-w-xs mb-5">
                    Thanks for reaching out — one of our counselors will contact
                    you within 24 hours.
                  </p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      value={form.message}
                      onChange={handleChange}
                      placeholder="Tell us about your academic background, target course, and any questions..."
                  ...
                  >
                    ...
                    {status === "submitting"
                      ? "Submitting..."
                      : "Submit — We Reply Within 24 Hours"}
                  </button>
          ...
          <ScrollReveal delay={150}>
            <div className="space-y-5">
              {contactCards.map((info, i) => (
                <div
                  key={i}
                  className={`${info.bg} rounded-2xl p-6 border border-white`}
                >
                  <div className="flex items-start gap-4">
                    <div
                      className={`w-10 h-10 rounded-xl bg-white flex items-center justify-center shadow-sm ${info.color} flex-shrink-0`}
                    >
                      {info.icon}
                    </div>
                    <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-100 mb-3">
                      Get instant answers from our counselors
                    </p>
                    <a
