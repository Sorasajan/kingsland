...
export type GalleryImageWhereInput = {
  ...
  size?: Prisma.StringFilter<"GalleryImage"> | string
...
export type GalleryImageScalarWhereWithAggregatesInput = {
  ...
  size?: Prisma.StringWithAggregatesFilter<"GalleryImage"> | string
...
export type GalleryImageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "src" | "alt" | "size" | "order" | "createdAt", ExtArgs["result"]["galleryImage"]>
...
export interface GalleryImageFieldRefs {
  ...
  readonly size: Prisma.FieldRef<"GalleryImage", 'String'>
